...
bool DecodeCanFrameV2(const struct can_frame *rx_frame, AgxMessage *msg) {
  ...
  switch (rx_frame->can_id) {
    ...
    case CAN_MSG_BMS_BASIC_ID: {
      ...
      msg->body.bms_basic_msg.current = ((int16_t)(frame->current.low_byte) |
           (int16_t)(frame->current.high_byte) << 8) *
          0.1;
      msg->body.bms_basic_msg.voltage = ((uint16_t)(frame->voltage.low_byte) |
           (uint16_t)(frame->voltage.high_byte) << 8) *
          0.1;
      msg->body.bms_basic_msg.temperature = ((uint16_t)(frame->temperature.low_byte) |
    ...
    case CAN_MSG_BMS_EXTENDED_ID: {
      ...
      msg->body.bms_extended_msg.battery_max_teperature = frame->battery_max_teperature;
      msg->body.bms_extended_msg.battery_min_teperature = frame->battery_min_teperature;
